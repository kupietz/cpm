...
From CPAN:
  ...
  $ curl -fsSL https://raw.githubusercontent.com/kupietz/cpm/main/cpm | perl - install -g App::cpm

Or, download a I<self-contained> cpm:

  $ curl -fsSL https://raw.githubusercontent.com/kupietz/cpm/main/cpm > cpm
  $ chmod +x cpm
  $ ./cpm --version
